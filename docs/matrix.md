...
- Attachments and encrypted media are not part of the initial Matrix adapter.
...
- Replies are sent in a Matrix thread using `m.relates_to.rel_type = "m.thread"` with a fallback reply relation.
